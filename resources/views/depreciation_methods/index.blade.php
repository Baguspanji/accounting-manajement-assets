            ...
            <table class="w-full text-left">
                <thead class="bg-slate-50 border-b border-slate-100 sticky top-0">
                    <tr>
                        ...
                        <th class="py-3 px-4 text-xs font-semibold text-text-secondary uppercase tracking-wider">Nama Metode</th>
                        <th class="py-3 px-4 text-xs font-semibold text-text-secondary uppercase tracking-wider">Formula</th>
                ...
                <tbody class="divide-y divide-slate-100">
                    @forelse ($methods as $method)
                        <tr class="hover:bg-slate-50 transition-colors">
                            ...
                            <td class="py-3 px-4 text-sm font-medium text-text-primary">{{ $method->name }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="py-8 px-4 text-center text-text-secondary">Belum ada data metode penyusutan.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
