            ...
            <div class="p-6 max-w-3xl space-y-4">
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="code" value="{{ old('code', $assetCategory->code) }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name', $assetCategory->name) }}" required
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="default_useful_life" value="{{ old('default_useful_life', $assetCategory->default_useful_life) }}"
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="default_residual_value" value="{{ old('default_residual_value', $assetCategory->default_residual_value) }}"
                            class="w-full px-4 py-2.5 border border-slate-200 rounded-xl outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary">
                    </div>
                </div>
                <div>
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="is_active" value="1" {{ old('is_active', $assetCategory->is_active) ? 'checked' : '' }} class="w-4 h-4 rounded border-slate-300 text-primary focus:ring-primary/30">
