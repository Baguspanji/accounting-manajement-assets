...
@section('content')
    <div class="flex flex-col md:flex-row justify-between md:items-center mb-6 gap-4">
        <div>
            ...
            <p class="text-slate-500 text-sm">Kelola register / kartu aset tetap perusahaan.</p>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left">
                <thead class="bg-slate-50 border-b border-slate-100 sticky top-0">
                    <tr>
                        <th class="py-3 px-4 text-xs font-semibold text-slate-500 uppercase tracking-wider">No. Aset</th>
                        <th class="py-3 px-4 text-xs font-semibold text-slate-500 uppercase tracking-wider">Nama Aset</th>
                        <th class="py-3 px-4 text-xs font-semibold text-slate-500 uppercase tracking-wider">Kategori</th>
                        <th class="py-3 px-4 text-xs font-semibold text-slate-500 uppercase tracking-wider">Harga Perolehan</th>
                        <th class="py-3 px-4 text-xs font-semibold text-slate-500 uppercase tracking-wider">Umur (th)</th>
                        <th class="py-3 px-4 text-xs font-semibold text-slate-500 uppercase tracking-wider">Metode</th>
                        ...
                        <tr class="hover:bg-slate-50 transition-colors">
                            ...
                            <td class="py-3 px-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="font-medium text-slate-800 text-sm">{{ $asset->name }}</p>
                            ...
                            <td class="py-3 px-4 text-right">
                                <div class="flex items-center justify-end gap-1">
                                    <a href="{{ route('assets.show', $asset->id) }}" class="p-1.5 hover:bg-info-light rounded-lg text-slate-500 hover:text-info">
                                        <i data-lucide="eye" class="w-4 h-4"></i>
                                    </a>
                                    <a href="{{ route('assets.edit', $asset->id) }}" class="p-1.5 hover:bg-warning-light rounded-lg text-slate-500 hover:text-warning">
